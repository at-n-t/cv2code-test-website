...
async function askAI(question) {
  ...
  const wrapEl    = document.getElementById("ai-response-wrap");
  ...
  try {
    ...
    if (!data.ok) {
      ...
      // Render answer with basic bold-text support (**text**)
      bodyEl.innerHTML = escHtml(data.answer)
...
document.getElementById("ai-clear-btn").addEventListener("click", () => {
  ...
  document.getElementById("ai-response-body").textContent   = "";
